...
local bar_offset_x = 230 -- default: 0
local bar_offset_y = 10 -- default: 0

local border_color = "000000"
local border_thickness = 4.7 -- default: 4
...
function onCreatePost()
	...
	makeLuaSprite('healthbarprey', 'healthbar/healthbarprey', 520, 630);
	addLuaSprite('healthbarprey', false)
	setObjectCamera('healthbarprey', "hud")	
	scaleLuaSprite('healthbarprey', 1.1, 1.1);
	setProperty('healthbarprey.antialiasing', false);
	setObjectOrder('healthbarprey', 2)
...
if downscroll then
setProperty('healthbarprey.y', getProperty('healthbarprey.y')-560)
end
end
