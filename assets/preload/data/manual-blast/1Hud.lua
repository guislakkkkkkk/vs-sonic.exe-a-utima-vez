...
makeAnimatedLuaSprite('scorchedhud', 'sonicUI/scorchedhud', 0, 0);
addAnimationByPrefix('scorchedhud', 'scorched', 'scorched', 20, true);  
addAnimationByPrefix('scorchedhud', 'glitch', 'glitch', 30, true);  
objectPlayAnimation('scorchedhud', 'scorched', true)
setProperty('scorchedhud.alpha', 0.00001);
scaleLuaSprite('scorchedhud', 1, 1) 
setObjectCamera('scorchedhud', 'other');
addLuaSprite('scorchedhud', true);
...
setProperty('scorchedhud.alpha', 1);
removeLuaSprite('hog')
end     
end
end
...
if curStep >= 815 then
setTextString('healthTxt', math.floor(getProperty('health')*50))
triggerEvent('Screen Shake', '0.10, 0.002', '0.1, 0.002')
...
function onStepHit()
if curStep > 450 then
doTweenX("Gay", "dad", 150, 0.2, "linear") 
doTweenX("Pan", "boyfriend", 740, 0.2, "linear") 
if curStep > 466 then
doTweenX("Gay", "dad", 180, 0.2, "linear") 
doTweenX("Pan", "boyfriend", 720, 0.2, "linear") 
if curStep > 482 then
doTweenX("Gay", "dad", 80, 0.2, "linear") 
doTweenX("Pan", "boyfriend", 820, 0.2, "linear") 
if curStep > 493 then
doTweenX("Gay", "dad", 155, 0.2, "linear") 
doTweenX("Pan", "boyfriend", 745, 0.2, "linear") 
if curStep > 504 then
doTweenX("Gay", "dad", 100, 0.3, "linear") 
doTweenX("Pan", "boyfriend", 800, 0.3, "linear") 
end
end
end
end
