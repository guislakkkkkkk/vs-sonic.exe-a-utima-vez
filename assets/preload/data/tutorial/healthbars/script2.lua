...
local width = 588 -- default: 593
local height = 25 -- default: 11

local bar_offset_x = 0 -- default: 0
local bar_offset_y = -25 -- default: 0

local border_color = "000000"
local border_thickness = 4 -- default: 4

local override_colors = true -- default: false
local override_p1_color = override_colors and "007BFF" or nil
local override_p2_color = override_colors and "000DD4" or nil

local p1_offset_x = -26 -- default: -26
local p1_offset_y = 10 -- default: 10
local p2_offset_x = 26 -- default: 26
local p2_offset_y = 10 -- default: 10
...
if downscroll then 
YB = -70
setProperty('healtbar_sonic_exe.flipY', true);
end
end
...
function onCreatePost()
	...
	makeLuaSprite('healtbar_sonic_exe', 'healthbar/healtbar_sonic_exe', 280, YB);
	addLuaSprite('healtbar_sonic_exe', false)
	setObjectCamera('healtbar_sonic_exe', "hud")	
	scaleLuaSprite('healtbar_sonic_exe', 1, 1);
	setObjectOrder('healtbar_sonic_exe', 2)
