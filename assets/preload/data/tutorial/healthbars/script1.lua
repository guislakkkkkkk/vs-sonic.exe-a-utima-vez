...
local width = 670 -- default: 593
local height = 11 -- default: 11

local bar_offset_x = -4 -- default: 0
local bar_offset_y = 60 -- default: 0
...
function onCreatePost()
	...
	makeLuaSprite('majinbar', 'healthbar/majinbar', 180, YB);
	addLuaSprite('majinbar', false)
	setObjectCamera('majinbar', "hud")	
	scaleLuaSprite('majinbar', 1.2, 1.1);
	setObjectOrder('majinbar', 2)
