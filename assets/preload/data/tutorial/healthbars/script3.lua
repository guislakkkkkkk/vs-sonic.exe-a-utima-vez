...
local bar_offset_y = -10 -- default: 0
...
local override_p2_color = override_colors and "00375C" or nil
...
function onCreatePost()
	...
	makeLuaSprite('healthbarimgod', 'healthbar/healthbarimgod', 260, 500);
	addLuaSprite('healthbarimgod', false)
	setObjectCamera('healthbarimgod', "hud")	
	scaleLuaSprite('healthbarimgod', 1, 1);
	setObjectOrder('healthbarimgod', 2)
