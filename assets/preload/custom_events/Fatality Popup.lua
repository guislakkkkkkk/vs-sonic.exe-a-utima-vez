...
function onCreate()
    ...
    makeLuaSprite('mouse', 'exe/fatal/fatal_mouse_cursor', getMouseX('other'), getMouseY('other'));   
    setProperty('mouse.antialiasing', false);
    scaleLuaSprite('mouse', 1.5, 1.5)
    addLuaSprite('mouse', true);
    setObjectCamera('mouse', 'other')	
    for i = 1,10 do
        makeAnimatedLuaSprite('error_popups'..i, 'exe/fatal/error_popups', getRandomInt(0, 700), getRandomInt(0, 300))
    ...
    if name == 'Fatality Popup' then 
        ...
        elseif value2 == 2 then
            for j = 1,value1 do
                ...
                ransize1 = 2.5
                makeAnimatedLuaSprite('error_popups'..ugh, 'exe/fatal/error_popups', getRandomInt(0, 600), getRandomInt(0, 300))
        ...
        elseif value2 == 3 then
            for j = 1,value1 do
                ...
                ransize1 = 4.7
                makeAnimatedLuaSprite('error_popups'..ugh, 'exe/fatal/error_popups', -40, -65)
                addAnimationByPrefix('error_popups'..ugh, 'idle', 'idle', 24, false);
                addAnimationByPrefix('error_popups'..ugh, 'end', 'end', 36, false);
                scaleObject('error_popups'..ugh, ransize1, ransize1)
                setProperty('error_popups'..ugh..'.antialiasing', false);
